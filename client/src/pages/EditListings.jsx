...
export default function CreateListing() {
    ...
    useEffect(()=>{
        console.log("Listing ID:", params.listingId); // Debugging
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    {formData.offer && (<div className='flex flex-cols items-center gap-2'>
                        <input type ='number' id='discountPrice' min='0' max="1000000" required className="p-3 border rounded-lg" onChange={handleChange} value={formData.discountPrice}/>
                        <p>Discounted Price
                        <span className='text-xs flex'>($ / month)</span> </p>
                    </div>) }
