    ...
    <>
      {landlord && (
        <div className='flex flex-col gap-2'>
            ...
            <Link to={`mailto:${landlord.email}?subject= Regarding ${listing.name}&body=${message}`} className="bg-slate-700 text-center text-white p-3 rounded-lg hover:opacity-95">
            Send Message
            </Link>
        </div>
      )}
